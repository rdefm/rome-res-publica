  ...
  // ─── PRAETOR ─────────────────────────────────────────────────────────────────
  {
    ...
    inOfficeActions: [
      ...
      },
      {
        ...
        name: 'Angle for a Choice Province (−12 Fides)',
        cost: '12 Fides',
        costVal: 12,
        resource: 'fides',
        desc: 'Guarantees a governorship of your choosing once this term ends, instead of one drawn at random.',
        spend: { fides: 12 },
  ...
  // ─── CONSUL ──────────────────────────────────────────────────────────────────
  {
    ...
    inOfficeActions: [
      ...
      },
      {
        ...
        name: 'Claim the Best Province (−8 Fides)',
        cost: '8 Fides',
        costVal: 8,
        resource: 'fides',
        desc: 'Guarantees a governorship of your choosing once this term ends, instead of one drawn at random — and doing so openly burnishes the family\'s reputation (+4 Dignitas).',
        spend: { fides: 8 },
