...
export function getCrisisInfo(crisisLevel: number): CrisisInfo {
  if (crisisLevel < 20) return {
    ...
    fidesPenalty: 0, dignitasPenalty: 0,
  };
  if (crisisLevel < 40) return {
    ...
    fidesPenalty: 1, dignitasPenalty: 0,
  };
  if (crisisLevel < 60) return {
    ...
    fidesPenalty: 2, dignitasPenalty: 1,
  };
  if (crisisLevel < 80) return {
    ...
    fidesPenalty: 3, dignitasPenalty: 2,
  };
  return {
    ...
    fidesPenalty: 5, dignitasPenalty: 4,
  };
}
