...
/**
 * Pending governor assignment — set by turnSequencer.ts's "tick office term"
 * step when a Praetor or Consul's term ends (whoever actually held it,
 * player or family member). Governor-assignment gap fix — this type,
