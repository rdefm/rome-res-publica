...
|---|---|---|---|---|
| Vigintivirate | 18 | 1 year | 6 | — |
| Quaestor | 30 | 1 year | 8 | — |
| Aedile | 36 | 1 year | 4 | Quaestor |
...
### The Theatre of War
The war is fought across **eight regions**: Cisalpine Gaul, Etruria, Latium, Samnium, and Campania on the Italian mainland, plus Sicily, Sardinia & Corsica, and Africa overseas — Latium itself can never be lost. Each region shows who currently holds it — Rome, Carthage, or nobody yet — and the Provinciae map shows every army in play as a token, exactly where it stands. Adjacency between regions tells you what's reachable and gives you intel on what's there before you commit to anything.

### Commands and the Legions
Someone has to lead Rome's war effort, and that someone is decided by an **Extraordinary Assembly** — a Senate election, called and resolved the same season, using the same machinery as any other office race. Win it and you become **Proconsul**: you gain Imperium, a state legion mustered at Latium, and a war chest kept entirely separate from your personal denarii, spendable only on musters and upkeep. Holding the Command sanctions your musters exactly like a formal office would. A rival can win the Command instead of you — if they do, their army fights the war under Carthage's own AI, and it's their record, not yours, on the line at the next vote.

A Command runs for one year. At its end comes **Prorogation** — an automatic re-election where your record in battle swings your support up or down; win it and your term extends with the war chest topped up, no fresh grant. Lose it, or stand unopposed by nobody at all, and the Command lapses: its armies hold in place, leaderless, until somebody wins it again.

Raising troops is a **Levy**, taken region by region, at one of three tiers: an **Emergency Levy** (cheap, whoever's on hand, poor quality), a **Standard Levy** (the ordinary muster), or **Picked Men** (a smaller, hand-selected muster — priced for its selectivity rather than its size, but reliably the better soldier for it). All three improve further with how well that region's cities regard Rome, and every region only has so many hands to give in a year. Musters raised without the Command's or a magistracy's sanction risk the same censure-and-consular-army response as any other unsanctioned levy.

### Movement and the Season's Playback
Each army gets **1 to 3 region-steps** of movement a season, spent moving into adjacent regions — friendly territory costs less than contested or hostile ground, and a sea lane (Sicily, Sardinia, Africa) always spends everything you have left, once you have enough to make the crossing. Winter and an oversized army both cost more; a **Forced March** buys one extra step at the price of some attrition along the way. You issue every army's orders for the season from one screen — combine armies together, split a detachment off, and set a standing **stance** (Give Battle or Avoid Battle) for however each one should react if the enemy comes looking.

Once every order is in and the season ends, watch it unfold: a skippable animated **playback** on the Provinciae tab replays exactly what the map decided — every march, every clash, every region that changed hands. Fights between two sides that aren't yours resolve on the spot as the playback runs; the moment the map puts your own army into a fight, the season pauses right there for you to settle it before anything else can continue.

### Engagements — Giving Battle
Adjacency only ever gives you intel and the choice to act on it — the instant an army actually steps into a region a hostile army holds, that step **is** the attack. There is never a formal declaration, a scheduled offer, or a fixed calendar of fights; you find out who's defending (cautious Hanno, cunning Hamilcar with his ambushes, reckless Bomilcar who charges everything, disciplined Xanthippus who never breaks formation) only once you're close enough to see them. Setting an army's stance to Avoid Battle beforehand is how you try to sidestep a fight you don't want — it isn't guaranteed, but a strong commander improves the odds of slipping away instead.

When the fight is yours to settle, you choose how: **Take the Field**, and play the real tactical battlefield yourself — three lanes (Left Wing, Centre, Right Wing) plus a Reserve, unit and formation assignments (cavalry can't stand in the centre; line, shield wall, and open ranks are always available, wedge and feigned retreat need a capable captain), a captain named per lane, a choice of where your own commander stands, and up to one pre-battle **stratagem** from your hand. Each round resolves the same way in every lane — a charge, a melee exchange, a morale toll from the casualties taken — and a lane whose morale breaks can be **pursued** for a harsher kill or used to **wheel** into the fight next door. Elephants remain a genuine gamble for both sides the longer a fight drags on. A battle ends once a side has lost two of its three wings and is scored **marginal**, **clear**, or **crushing** — casualties, War Score, and any captains lost, wounded, or captured all follow from that tier. A captured family member can be **ransomed**, **negotiated** down (a sharp Intrigus mind can halve the price), or **refused** — leaving them a prisoner, and costing you standing for abandoning them.

Or **Trust the Legate**, and let the same abstract math that settles every other army's fight decide it in a moment — faster, no less fair, but you don't get to shape it yourself.

### War Standing and Peace
A single running number, **War Score** (−100 to +100, positive favouring Rome), tracks the whole war — and unlike a scripted script, it's recomputed fresh every season straight from how the map actually stands: who holds Sicily's cities, whose army is the stronger one in the field, momentum carried forward from recent fighting (a crushing win swings it hard, a narrow one barely at all — no single battle can ever swing it past a hard cap), and which side is more worn down by the fighting so far. Leave a war to grind on for years and that weariness alone can eventually force the issue, whatever the score currently reads.
...
### What Happened to the Old Campaign Types
The Carthage war is the only conflict fought on the theatre map. Every other campaign in the game — provincial revolts, suppression, allied support elsewhere in the Republic — still runs the old way described in §8: raise a legion, volunteer an officer, weather the suppression's own pivotal moments. The two systems were deliberately never merged for this version of the game; nothing about them changed when the theatre map arrived, and nothing here reaches into how they resolve.
